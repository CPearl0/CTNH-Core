...
public class CTNHNoiseGenerationSettings {
        ...
        public static final ResourceKey<NoiseGeneratorSettings> ASTRAL_PLANET = ResourceKey
                        .create(Registries.NOISE_SETTINGS, CTNHCore.id("astral_planet"));
                ...
                ctx.register(ASTRAL_PLANET, new NoiseGeneratorSettings(NoiseSettings.create(-64, 384, 1, 2),
                                ...
                                new NoiseRouter(DensityFunctions.noise(holderGetter2.getOrThrow(Noises.AQUIFER_BARRIER),
                                                ...
                                                new DensityFunctions.HolderHolder(
                                                                holderGetter.getOrThrow(CTNHDensityFunctions.DEPTH)),
                                                ...
                                                DensityFunctions.mul(DensityFunctions.constant(4), DensityFunctions.mul(
                                                                new DensityFunctions.HolderHolder(holderGetter
                                                                                .getOrThrow(CTNHDensityFunctions.DEPTH)),
                                                                DensityFunctions.cache2d(
                                                                                new DensityFunctions.HolderHolder(
                                                                                                holderGetter.getOrThrow(
                                                                                                                CTNHDensityFunctions.FACTOR))))
                                                                .quarterNegative()),
                                                new DensityFunctions.HolderHolder(holderGetter
                                                                .getOrThrow(CTNHDensityFunctions.FINAL_DENSITY)),
                                                DensityFunctions.zero(),
                                                DensityFunctions.zero(),
                                                DensityFunctions.zero()),
                                                ...
                                                SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(),
                                                                SurfaceRules.sequence(
                                                                                SurfaceRules.ifTrue(SurfaceRules
                                                                                                .isBiome(CTNHBiomes.PLAGUE_WASTELAND),
                                                                                                SurfaceRules.sequence(
                                                                                                                SurfaceRules.ifTrue(
                                                                                                                ...
                                                                                                                ASTRAL_STONE)),
                                                                                SurfaceRules.ifTrue(SurfaceRules
                                                                                                .isBiome(CTNHBiomes.PLAGUE_DESERT),
                                                                                                SurfaceRules.ifTrue(
                                ...
                                new NoiseRouter(DensityFunctions.noise(holderGetter2.getOrThrow(Noises.AQUIFER_BARRIER),
                                                ...
                                                DensityFunctions.mul(DensityFunctions.constant(4), DensityFunctions.mul(
                                                                new DensityFunctions.HolderHolder(holderGetter
                                                                                .getOrThrow(CTNHDensityFunctions.DEPTH)),
                                                                new DensityFunctions.HolderHolder(holderGetter
                                                                                .getOrThrow(CTNHDensityFunctions.FACTOR)))),
                                                new DensityFunctions.HolderHolder(holderGetter
                                                                .getOrThrow(CTNHDensityFunctions.FINAL_DENSITY)),
                                                DensityFunctions.zero(),
                                                DensityFunctions.zero(),
