        ...
        return REGISTRATE.multiblock("hyper_plasma_turbine", HyperPlasmaTurbineMachine::new)
                ...
                .pattern(definition -> {
                    return FactoryBlockPattern.start()
                            ...
                            .aisle("#############################", "#############################",
                                    "#############################", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                    "#BCCCCCCCCCB#####BCCCCCCCCCB#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "#CCCCCCCCCCB#####BCCCCCCCCCC#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "#BCCCCCCCCCB#####BCCCCCCCCCB#", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                    "#############################", "#############################",
                                    "#############################")
                            .aisle("#############################", "#############################",
                                    "#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "BBAAAAAAAAABEEEEEBAAAAAAAAABB",
                                    "#CAAAAAAAAABEEEEEBAAAAAAAAAC#", "BBAAAAAAAAABEEEEEBAAAAAAAAABB",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "#############################", "#############################",
                                    "#############################")
                            .aisle("#############################", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                    "#BCCCCCCCCCB#####BCCCCCCCCCB#", "#BAAAAAAAAAB#####BAAAAAAAAAB#",
                                    "BDAAAAAAAAABBBBBBBAAAAAAAAADB", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "#CAAAAAAAAABFFFFFBAAAAAAAAAC#", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "BDAAAAAAAAABBBBBBBAAAAAAAAADB", "#BAAAAAAAAAB#####BAAAAAAAAAB#",
                                    "#BCCCCCCCCCB#####BCCCCCCCCCB#", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                    "#############################")
                            .aisle("#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "BDAAAAAAAAABBBBBBBAAAAAAAAADB",
                                    "BDAAAAAAAAABFFFFFBAAAAAAAAADB", "BBAAAAAAAAABGHFGHBAAAAAAAAABB",
                                    "#CAAAAAAAAABGHFGHBAAAAAAAAAC#", "BBAAAAAAAAABGHFGHBAAAAAAAAABB",
                                    "BDAAAAAAAAABFFFFFBAAAAAAAAADB", "BDAAAAAAAAABBBBBBBAAAAAAAAADB",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "#############################")
                            .aisle("#BBBBBBBBBBB#####BBBBBBBBBBB#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "BBAAAAAAAAABEEEEEBAAAAAAAAABB", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "BBAAAAAAAAABHGFHGBAAAAAAAAABB", "BBAAAAAAAAABHGFHGBAAAAAAAAABB",
                                    "#CAAAAAAAAABHGFHGBAAAAAAAAAC#", "BBAAAAAAAAABGHFGHBAAAAAAAAABB",
                                    "BBAAAAAAAAABHGFHGBAAAAAAAAABB", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "BBAAAAAAAAABEEEEEBAAAAAAAAABB", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "#BBBBBBBBBBB#####BBBBBBBBBBB#")
                            .aisle("#############################", "#CCCCCCCCCCB#####BCCCCCCCCCC#",
                                    "#CAAAAAAAAABEEEEEBAAAAAAAAAC#", "#CAAAAAAAAABFFFFFBAAAAAAAAAC#",
                                    "#CAAAAAAAAABHGFHGBAAAAAAAAAC#", "#CAAAAAAAAABGHFGHBAAAAAAAAAC#",
                                    "I##RRRRRRRRKKKFKKKrrrrrrrr##i", "#CAAAAAAAAABGHFGHBAAAAAAAAAC#",
                                    "#CAAAAAAAAABHGFHGBAAAAAAAAAC#", "#CAAAAAAAAABFFFFFBAAAAAAAAAC#",
                                    "#CAAAAAAAAABEEEEEBAAAAAAAAAC#", "#CCCCCCCCCCB#####BCCCCCCCCCC#",
                                    "#############################")
                            .aisle("#BBBBBBBBBBB#####BBBBBBBBBBB#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "BBAAAAAAAAABEEEEEBAAAAAAAAABB", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "BBAAAAAAAAABHGFHGBAAAAAAAAABB", "BBAAAAAAAAABGHFGHBAAAAAAAAABB",
                                    "#CAAAAAAAAABHGFHGBAAAAAAAAAC#", "BBAAAAAAAAABHGFHGBAAAAAAAAABB",
                                    "BBAAAAAAAAABHGFHGBAAAAAAAAABB", "BBAAAAAAAAABBBBBBBAAAAAAAAABB",
                                    "BBAAAAAAAAABEEEEEBAAAAAAAAABB", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                    "#BBBBBBBBBBB#####BBBBBBBBBBB#")
                            .aisle("#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                            ...
                            .aisle("#############################", "#############################",
                                    "#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "BBAAAAAAAAABEEEEEBAAAAAAAAABB",
                                    "#CAAAAAAAAABEE@EEBAAAAAAAAAC#", "BBAAAAAAAAABEEEEEBAAAAAAAAABB",
                                    "BDAAAAAAAAAB#####BAAAAAAAAADB", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                    "#############################", "#############################",
                                    "#############################")
                            .aisle("#############################", "#############################",
                            ...
                            .where("H", Predicates.blocks(GTBlocks.SUPERCONDUCTING_COIL.get()))
                ...
                .shapeInfo(definition -> MultiblockShapeInfo.builder()
                        ...
                        .aisle("#############################", "#############################",
                                "#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                "BD#########B#####B#########DB", "BB#########BEEEEEB#########BB",
                                "#C#########BfE@ceB#########C#", "BB#########BEEEEEB#########BB",
                                "BD#########B#####B#########DB", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                "#############################", "#############################",
                                "#############################")
                        .aisle("#############################", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                "#BCCCCCCCCCB#####BCCCCCCCCCB#", "#B#########B#####B#########B#",
                                "BD#########BBBBBBB#########DB", "BB#########BBBBBBB#########BB",
                                "#C#########BFFFFFB#########C#", "BB#########BBBBBBB#########BB",
                                "BD#########BBBBBBB#########DB", "#B#########B#####B#########B#",
                                "#BCCCCCCCCCB#####BCCCCCCCCCB#", "#BBBBBBBBBBB#####BBBBBBBBBBB#",
                                "#############################")
                        .aisle("#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                "BD#########B#####B#########DB", "BD#########BBBBBBB#########DB",
                                "BD#########BFFFFFB#########DB", "BB#########BGHFGHB#########BB",
                                "#C#########BGHFGHB#########C#", "BB#########BGHFGHB#########BB",
                                "BD#########BFFFFFB#########DB", "BD#########BBBBBBB#########DB",
                                "BD#########B#####B#########DB", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
                                "#############################")
                        .aisle("#BBBBBBBBBBB#####BBBBBBBBBBB#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                "BB#########BEEEEEB#########BB", "BB#########BBBBBBB#########BB",
                                "BB#########BHGFHGB#########BB", "BB#########BHGFHGB#########BB",
                                "#C#########BHGFHGB#########C#", "BB#########BGHFGHB#########BB",
                                "BB#########BHGFHGB#########BB", "BB#########BBBBBBB#########BB",
                                "BB#########BEEEEEB#########BB", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                "#BBBBBBBBBBB#####BBBBBBBBBBB#")
                        .aisle("#############################", "#CCCCCCCCCCB#####BCCCCCCCCCC#",
                                "#C#########BEEEEEB#########C#", "#C#########BFFFFFB#########C#",
                                "#C#########BHGFHGB#########C#", "#C#########BGHFGHB#########C#",
                                "I##RRRRRRRRKKKFKKKrrrrrrrr##i", "#C#########BGHFGHB#########C#",
                                "#C#########BHGFHGB#########C#", "#C#########BFFFFFB#########C#",
                                "#C#########BEEEEEB#########C#", "#CCCCCCCCCCB#####BCCCCCCCCCC#",
                                "#############################")
                        .aisle("#BBBBBBBBBBB#####BBBBBBBBBBB#", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                "BB#########BEEEEEB#########BB", "BB#########BBBBBBB#########BB",
                                "BB#########BHGFHGB#########BB", "BB#########BGHFGHB#########BB",
                                "#C#########BHGFHGB#########C#", "BB#########BHGFHGB#########BB",
                                "BB#########BHGFHGB#########BB", "BB#########BBBBBBB#########BB",
                                "BB#########BEEEEEB#########BB", "BBCCCCCCCCCB#####BCCCCCCCCCBB",
                                "#BBBBBBBBBBB#####BBBBBBBBBBB#")
                        .aisle("#############################", "#BCCCCCCCCCB#####BCCCCCCCCCB#",
