...
//            if (mm.metaMachine instanceof MultiblockTankMachine tankMachine) {
...
//                fluidBlockRenderer.drawPlane(up, tankMachine.getFluidBlockOffsets(), pose, consumer, cachedFluid,
