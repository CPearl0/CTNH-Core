...
public class CTNHCoreDatagen {
    public static final ProviderType<RegistrateCNLangProvider> CNLANG = ProviderType.register("cn_lang", (p, e) -> new RegistrateCNLangProvider(p, e.getGenerator().getPackOutput()));
